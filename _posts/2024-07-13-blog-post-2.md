...
| [dynlint](https://github.com/trailofbits/dylint) | Run Rust lints from dynamic libraries | HIR | Versatile | Pattern matching | ★★★★★ |
...
| [Creusot](https://github.com/creusot-rs/creusot) | A deductive verifier for Rust code. | WhyML | Panics, overflows, Assertion failures | - | ★★★★★ |
